...
export default function DocumentationSlide() {
  return (
    <div className="min-h-screen bg-[#111111] text-white p-4 md:p-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/New_Stripe_Website__Community_-qTbZtPQxxtdbg4KiBK12qneOoFJsEz.png"
          ...
          <div className="flex justify-end mt-8">
            <Button variant="secondary" className="bg-white/10 hover:bg-white/20 text-white rounded-lg px-8 py-2">
              Next
